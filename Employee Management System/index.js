...
function addEmploye(){
    ...
    for( var i in table){
        ...
        tr.cells[0].addEventListener("click",function(){
            ...
            document.getElementById("giveName").innerHTML="<h6>"+this.parentNode.childNodes[0].innerHTML+"</h6>";
            document.getElementById("giveEmail").innerHTML="<h6>"+this.parentNode.childNodes[1].innerHTML+"</h6>";
            document.getElementById("givePhone").innerHTML="<h6>"+this.parentNode.childNodes[2].innerHTML+"</h6>";
        });
        tr.cells[1].addEventListener("click",function(){
        ...
        tr.cells[2].addEventListener("click",function(){
            console.log(this.childNodes);
            document.getElementsByClassName("addEmployee")[0].style.display="none";
            document.getElementById("section-2").style.display="none";
            document.getElementById("section-3").style.display="none";
